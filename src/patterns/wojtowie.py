...
def rule_patterns_wojtowie() -> list:
    ...
    patterns = [
        ...
        [{"LEMMA":"wójtowy"}, {"LOWER":"m"}, {"IS_PUNCT":True},
         {"ENT_TYPE":"PLACENAME", "OP": "+"}],
        [{"LEMMA":"wójcina"}, {"LOWER":"m"}, {"IS_PUNCT":True},
         {"ENT_TYPE":"PLACENAME", "OP": "+"}],
        # wójt wsi nazwa
        ...
        [{"LEMMA":"wójt"}, {"LEMMA":"sąd"}, {"POS":"ADJ"}, {"LOWER":"pr"}, {"IS_PUNCT":True},
         {"LOWER":"niem"}, {"IS_PUNCT":True}, {"LOWER":"na"}, {"LEMMA":"zamek"}, {"LOWER":"krak"},
         {"IS_PUNCT":True}],
        # wójt sądu pr. niem. w kluczu łąckim
        [{"LEMMA":"wójt"}, {"LEMMA":"sąd"}, {"LOWER":"pr"}, {"IS_PUNCT":True}, {"LOWER":"niem"},
         {"IS_PUNCT":True}, {"LOWER":"w"}, {"LEMMA":"klucz"}, {"POS":"ADJ"}],
        # wójt sądu wyższego dworskiego kl. miech.
        [{"LEMMA":"wójt"}, {"LEMMA":"sąd"}, {"POS":"ADJ", "OP":"+"}, {"LOWER":"kl"},
         {"IS_PUNCT":True}, {"LOWER":"miech"}, {"IS_PUNCT":True}],
        # wójt sądu najw. pr. niem. na zamku krak.
        [{"LEMMA":"wójt"}, {"LEMMA":"sąd"}, {"LOWER":"najw"}, {"IS_PUNCT":True},
         {"LOWER":"pr"}, {"IS_PUNCT":True}, {"LOWER":"niem"}, {"IS_PUNCT":True},
         {"LOWER":"na"}, {"LEMMA":"zamek"}, {"LOWER":"krak"}, {"IS_PUNCT":True}],
        # wójt sądu wyższego pr. niem. w + nazwa (klasztor, zamek, miasto)
        [{"LEMMA":"wójt"}, {"LEMMA":"sąd"}, {"POS":"ADJ"}, {"LOWER":"pr"}, {"IS_PUNCT":True},
         {"LOWER":"niem"}, {"IS_PUNCT":True}, {"LOWER":"w"}, {"ENT_TYPE":"PLACENAME", "OP":"+"}],
        [{"LEMMA":"wójt"}, {"LEMMA":"sąd"}, {"POS":"ADJ"}, {"LOWER":"pr"}, {"IS_PUNCT":True},
         {"LOWER":"niem"}, {"IS_PUNCT":True}, {"LOWER":"w"}, {"ENT_TYPE":"PLACENAME", "OP":"+"}],
        # wójt sądu leńskiego w + nazwa
        [{"LEMMA":"wójt"}, {"LEMMA":"sąd"}, {"POS":"ADJ"}, {"LOWER":"w"},
         {"POS":"PROPN", "OP":"+"}],
        [{"LEMMA":"wójt"}, {"LEMMA":"sąd"}, {"POS":"ADJ"}, {"LOWER":"w"},
         {"POS":"NOUN", "OP":"+"}],
        # wójt sądu wyższego dworskiego pr. niem. + nazwa
        [{"LEMMA":"wójt"}, {"LEMMA":"sąd"}, {"POS":"ADJ"}, {"POS":"ADJ"}, {"LOWER":"pr"},
         {"IS_PUNCT":True}, {"LOWER":"niem"}, {"IS_PUNCT":True},
         {"ENT_TYPE":"PLACENAME", "OP":"+"}],
        # wójt sądu wyższego pr. niem. magd.
        [{"LEMMA":"wójt"}, {"LEMMA":"sąd"}, {"LEMMA":"prawo"}, {"LOWER":"niem"},
         {"IS_PUNCT":True}, {"LOWER":"magd"}, {"IS_PUNCT":True}],
        # wójt sądu prawa niem.
        [{"LEMMA":"wójt"}, {"LEMMA":"sąd"}, {"LEMMA":"prawo"}, {"LOWER":"niem"}, {"IS_PUNCT":True}],
        # wójt sądu wyższego prawa niem.
        [{"LEMMA":"wójt"}, {"LEMMA":"sąd"}, {"POS":"ADJ"}, {"LEMMA":"prawo"}, {"LOWER":"niem"},
         {"IS_PUNCT":True}],
        # wójt i mieszcz. z nazwa, wójt i mieszczanin z nazwa, wójt i mieszcz. nazwa
        [{"LEMMA":"wójt"}, {"LOWER":"i"}, {"LEMMA":"mieszcz"}, {"IS_PUNCT":True}, {"LOWER":"z"},
         {"ENT_TYPE":"PLACENAME"}],
        [{"LEMMA":"wójt"}, {"LOWER":"i"}, {"LEMMA":"mieszczanin"}, {"LOWER":"z"},
         {"ENT_TYPE":"PLACENAME"}],
        [{"LEMMA":"wójt"}, {"LOWER":"i"}, {"LEMMA":"mieszcz"}, {"IS_PUNCT":True},
         {"ENT_TYPE":"PLACENAME"}],
    ...
    for shortcut in shortcuts:
        ...
        patterns.append([{"LEMMA":"wójt"}, {"LOWER":"z"}, {"LOWER":f"{shortcut}"},
                         {"IS_PUNCT":True}])
        patterns.append([{"LEMMA":"wójtowy"}, {"LOWER":"z"}, {"LOWER":f"{shortcut}"},
                         {"IS_PUNCT":True}])
        patterns.append([{"LEMMA":"wójcina"}, {"LOWER":"z"}, {"LOWER":f"{shortcut}"},
                         {"IS_PUNCT":True}])
        # wójt + 'w' + skrót (geograficzny) np krak. biec. lel.
        patterns.append([{"LEMMA":"wójt"}, {"LOWER":"w"}, {"LOWER":f"{shortcut}"},
                         {"IS_PUNCT":True}])
        patterns.append([{"LEMMA":"wójtowy"}, {"LOWER":"w"}, {"LOWER":f"{shortcut}"},
                         {"IS_PUNCT":True}])
        patterns.append([{"LEMMA":"wójcina"}, {"LOWER":"w"}, {"LOWER":f"{shortcut}"},
                         {"IS_PUNCT":True}])

        # wójt + 'm' + skrót (geograficzny) np krak. biec. lel.
        patterns.append([{"LEMMA":"wójt"}, {"LOWER":"m"}, {"IS_PUNCT":True},
                         {"LOWER":f"{shortcut}"}, {"IS_PUNCT":True}])
        patterns.append([{"LEMMA":"wójtowy"}, {"LOWER":"m"}, {"IS_PUNCT":True},
                         {"LOWER":f"{shortcut}"}, {"IS_PUNCT":True}])
        patterns.append([{"LEMMA":"wójcina"}, {"LOWER":"m"}, {"IS_PUNCT":True},
                         {"LOWER":f"{shortcut}"}, {"IS_PUNCT":True}])

    # wójt z + skrót miejscowości np.: A.
    for litera in litery:
        patterns.append([{"LEMMA":"wójt"}, {"LOWER":"z"}, {"TEXT":f"{litera}"}, {"IS_PUNCT":True}])
        patterns.append([{"LEMMA":"wójtowy"}, {"LOWER":"z"}, {"TEXT":f"{litera}"},
                         {"IS_PUNCT":True}])
