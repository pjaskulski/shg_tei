...
def rule_patterns_podwojtowie() -> list:
    ...
    patterns = [
        ...
        # podwójt m. nazwa
        [{"LEMMA":"podwójt"}, {"LOWER":"m"}, {"IS_PUNCT":True}, {"ENT_TYPE":"PLACENAME", "OP": "+"}],
        [{"LOWER":"podwójci"}, {"LOWER":"m"}, {"IS_PUNCT":True}, {"ENT_TYPE":"PLACENAME", "OP": "+"}],
        [{"LEMMA":"podwójtowy"}, {"LOWER":"m"}, {"IS_PUNCT":True}, {"ENT_TYPE":"PLACENAME", "OP": "+"}],
        [{"LEMMA":"podwójcina"}, {"LOWER":"m"}, {"IS_PUNCT":True}, {"ENT_TYPE":"PLACENAME", "OP": "+"}],
        [{"LOWER":"podwójcina"}, {"LOWER":"m"}, {"IS_PUNCT":True}, {"ENT_TYPE":"PLACENAME", "OP": "+"}],
        ...
        [{"LOWER":"podwójci"}, {"LOWER":"z"}, {"LEMMA":"wieś"}, {"ENT_TYPE":"PLACENAME", "OP": "+"}],
        [{"LEMMA":"podwójtowy"}, {"LOWER":"z"}, {"LEMMA":"wieś"}, {"ENT_TYPE":"PLACENAME", "OP": "+"}],
        [{"LEMMA":"podwójcina"}, {"LOWER":"z"}, {"LEMMA":"wieś"}, {"ENT_TYPE":"PLACENAME", "OP": "+"}],
        [{"LOWER":"podwójcina"}, {"LOWER":"z"}, {"LEMMA":"wieś"}, {"ENT_TYPE":"PLACENAME", "OP": "+"}],
        # podwójt ze wsi nazwa
        [{"LEMMA":"podwójt"}, {"LOWER":"ze"}, {"LEMMA":"wieś"}, {"ENT_TYPE":"PLACENAME", "OP": "+"}],
        [{"LOWER":"podwójci"}, {"LOWER":"ze"}, {"LEMMA":"wieś"}, {"ENT_TYPE":"PLACENAME", "OP": "+"}],
        [{"LEMMA":"podwójtowy"}, {"LOWER":"ze"}, {"LEMMA":"wieś"}, {"ENT_TYPE":"PLACENAME", "OP": "+"}],
        [{"LEMMA":"podwójcina"}, {"LOWER":"ze"}, {"LEMMA":"wieś"}, {"ENT_TYPE":"PLACENAME", "OP": "+"}],
        [{"LOWER":"podwójcina"}, {"LOWER":"ze"}, {"LEMMA":"wieś"}, {"ENT_TYPE":"PLACENAME", "OP": "+"}],
        ...
        [{"LEMMA":"podwójt"}, {"LEMMA":"sąd"}, {"POS":"ADJ"}, {"LOWER":"w", "OP":"?"}, {"ENT_TYPE":"PLACENAME"}],
        [{"LOWER":"podwójci"}, {"LEMMA":"sąd"}, {"POS":"ADJ"}, {"LOWER":"w", "OP":"?"}, {"ENT_TYPE":"PLACENAME"}],
        [{"LEMMA":"podwójt"}, {"LEMMA":"sąd"}, {"LEMMA":"leński"}, {"LOWER":"w", "OP":"?"}, {"ENT_TYPE":"PLACENAME"}],
        [{"LOWER":"podwójci"}, {"LEMMA":"sąd"}, {"LEMMA":"leński"}, {"LOWER":"w", "OP":"?"}, {"ENT_TYPE":"PLACENAME"}],
        # podwójt sądu leńskiego + nazwa (opcjonalnie - z)
        [{"LEMMA":"podwójt"}, {"LEMMA":"sąd"}, {"POS":"ADJ"}, {"LOWER":"z", "OP":"?"}, {"ENT_TYPE":"PLACENAME"}],
        [{"LOWER":"podwójci"}, {"LEMMA":"sąd"}, {"POS":"ADJ"}, {"LOWER":"z", "OP":"?"}, {"ENT_TYPE":"PLACENAME"}],
        [{"LEMMA":"podwójt"}, {"LEMMA":"sąd"}, {"LEMMA":"leński"}, {"LOWER":"z", "OP":"?"}, {"ENT_TYPE":"PLACENAME"}],
        [{"LOWER":"podwójci"}, {"LEMMA":"sąd"}, {"LEMMA":"leński"}, {"LOWER":"z", "OP":"?"}, {"ENT_TYPE":"PLACENAME"}],
        # podwójt leńskiego sądu
        [{"LEMMA":"podwójt"}, {"POS":"ADJ"}, {"LEMMA":"sąd"}, {"LOWER":"w", "OP":"?"}, {"ENT_TYPE":"PLACENAME"}],
