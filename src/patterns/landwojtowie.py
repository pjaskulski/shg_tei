...
def rule_patterns_landwojtowie() -> list:
    ...
    patterns = [
        ...
        # landwójt m. nazwa
        [{"LEMMA":"landwójt"}, {"LOWER":"m"}, {"IS_PUNCT":True},
        ...
        [{"LEMMA":"landwójt"}, {"LOWER":"z"}, {"LEMMA":"wieś"},
         {"ENT_TYPE":"PLACENAME", "OP": "+"}],
        # landwójt ze wsi nazwa
        [{"LEMMA":"landwójt"}, {"LOWER":"ze"}, {"LEMMA":"wieś"},
         {"ENT_TYPE":"PLACENAME", "OP": "+"}],
        # landwójt sądu pr. niem. + nazwa
        [{"LEMMA":"landwójt"}, {"LEMMA":"sąd"}, {"LOWER":"pr"}, {"IS_PUNCT":True},
         {"LOWER":"niem"}, {"IS_PUNCT":True}, {"LOWER":"w", "OP":"?"}, {"ENT_TYPE":"PLACENAME"}],
        # landwójt sądu prawa niem. + nazwa
        [{"LEMMA":"landwójt"}, {"LEMMA":"sąd"}, {"LOWER":"prawa"}, {"LOWER":"niem"},
         {"IS_PUNCT":True}, {"LOWER":"w", "OP":"?"}, {"ENT_TYPE":"PLACENAME"}]
    ]
    ...
    for shortcut in shortcuts:
        ...
        patterns.append([{"LEMMA":"landwójt"}, {"LOWER":"z"}, {"LOWER":f"{shortcut}"},
                         {"IS_PUNCT":True}])
        # landwójt + 'w' + skrót (geograficzny) np krak. biec. lel.
        patterns.append([{"LEMMA":"landwójt"}, {"LOWER":"w"}, {"LOWER":f"{shortcut}"},
                         {"IS_PUNCT":True}])
        # landwójt + 'm' + skrót (geograficzny) np krak. biec. lel.
        patterns.append([{"LEMMA":"landwójt"}, {"LOWER":"m"}, {"IS_PUNCT":True},
                         {"LOWER":f"{shortcut}"}, {"IS_PUNCT":True}])

    # podwójt z + skrót miejscowości np.: A.
    for litera in litery:
        patterns.append([{"LEMMA":"landwójt"}, {"LOWER":"z"}, {"TEXT":f"{litera}"},
                         {"IS_PUNCT":True}])
        patterns.append([{"LEMMA":"landwójt"}, {"LOWER":"w"}, {"TEXT":f"{litera}"},
                         {"IS_PUNCT":True}])
